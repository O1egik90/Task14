    ...
    <main>
        <div class="page-content">
            <div class="main-header content-block">
                ...
                <h1><strong><span style=" font-size: text-transfporm: uppercase; x-large; color: #d6ee25;">AsiaSPA</span></strong></h1>
                </div>
                <div style="flex: 2; margin-left: 20px">
                    <p><strong><span style=" font-size: x-large; color: #d6ee25;">+7988 123 45 67</span></strong></p>
                    <p><strong><span style="font-size: x-large; color: #d6ee25;">+7988 321 54 76</span></strong></p>
                    <p></p>
                    <p><span style="color: #d6ee25; font-size: medium;"><strong>9:00-23:00</strong></span></p>
                    <p></p>
                    <p style="text-align: center;">
                        <span style="text-decoration: underline;">
                            <a href="https://www.facebook.com/" target="_blank" rel="noopener"><img style="border: 0px none; vertical-align: middle; margin: 10px; float: left;" src="image/facebook-256-1.png" alt="" width="25" height="25"></a>
                            <a href="https://www.youtube.com/" target="_blank" rel="noopener"><img style="border: 0px none; vertical-align: middle; margin: 10px; float: left;" src="image/youtube-256-1.png" alt="" width="25" height="25"></a>
                            <a href="https://twitter.com/" target="_blank" rel="noopener"><img style="border: 0px none; vertical-align: middle; margin: 10px; float: left;" src="image/twitter-256-1.png" alt="" width="25" height="25"></a>
                            <a href="https://www.instagram.com/" target="_blank" rel="noopener"><img style="border: 0px none; vertical-align: middle; margin: 10px; float: left;" src="image/instagram-256-1.png" alt="" width="25" height="25"></a>
                    </p>
                    <p></p>
            ...
            <div class="content">
                ...
                <div class="main-content ">
                    <div id="action_content" class="main-content-item content-block" style="display: none;">
                        ...
                        <hr>
                        <img src="image/face2.jpg" alt="Акция для новых клиентов" style="width: 100%;">
                    ...
                    if ($login && !$birthday) { ?>
                        <div id="set_birthday" class="main-content-item content-block">
                            <img src="image/HB.jpg" alt="День рождения" style="width: 100%;">
                            <div class="slide-text text-top">
                                <span style="font-size: 16px;">Укажите <a href="profile.php">дату рождения в своем профиле</a> чтобы получить приятный сюрприз к празднику!</span>
                                </span>
                            </div>
                        </div>
                    <?php  }
                    ...
                    ?>
                        <div id="birthday_content" class="main-content-item content-block">
                            ...
                            <hr>
                            <img src="image/sertif.jpg" alt="Подарочный сертификат" style="width: 100%;">
                            <div class="slide-text text-bottom">
                    ...
                    <?php } ?>
                    <div class="main-content-item content-block">
                        <img src="image/new2.jpg" alt="Новые услуги" style="width: 100%;">
                        <div class="slide-text text-top">
                    ...
                    <div class="main-content-item content-block">
                        <img src="image/two.jpg" alt="СПА для двоих" style="width: 100%;">
                        <div class="slide-text text-top">
                            <span style="font-size: 16px;">Уникальная услуга - СПА для пар, приводите вторую половинку и окунитесь в мир отдыха вместе!
                            </span>
                        </div>
                    </div>
                </div>
